...
#ifndef ObfuscateString
    #define ObfuscateString NSMutableString.string
#else
    #error ObfuscateString macro already defined, please rename your macro.
#endif

@interface NSMutableString (GObfuscatedString)
